...
- When automatic Codex review is enabled, opening or updating the pull request schedules the review. Do not also post `@codex review` or make another manual request; duplicate reviews waste review capacity and tokens. Request a review manually only when automatic review is disabled.
